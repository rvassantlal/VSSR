...
import vssr.client.ConfidentialServiceProxy;
...
public class KVStore {
	...
	public String put(String key, String value) {
		try {
			...
			return (response.getConfidentialData() != null && response.getConfidentialData().length > 0) ? new String(response.getConfidentialData()[0]) : null;
